...
**[View Live Demo](https://heltrakinho07.github.io/geological-web-map-mozambique/)**

## Features

### Interactive Mapping
- **Real-time geological data visualization** (7,843 features - filtered version)
...
- **7,843 geological units** covering all of Mozambique (filtered version)
...
**[View Live Demo](https://heltrakinho.github.io/geological-web-map-mozambique/)**
